...
export function fuzzySearch(needle, haystack, threshold = 0.85) {
    if (typeof needle !== "string" || typeof haystack !== "string")
        throw new Error("Both needle and haystack must be strings");
...
export function contextAwareFuzzySearch(needle, haystack, prefix, suffix, threshold = 0.85) {
    if (typeof needle !== "string" || typeof haystack !== "string")
        throw new Error("Both needle and haystack must be strings");
    if (needle.length === 0 || haystack.length === 0)
        return null;
